        ...
        {TREND_DATA.map(d=>{
          ...
          return(
            <div key={d.month} style={{flex:1,display:"flex",flexDirection:"column",alignItems:"center",gap:3}}>
              <span style={{fontSize:9,fontWeight:700,color:"#6d28d9"}}>{d.tickets}</span>
                  ...
                  {COMMON_ISSUES.map((issue,i)=>(
                    <div key={i} style={{display:"flex",alignItems:"center",gap:8,padding:"5px 0",borderBottom:i<COMMON_ISSUES.length-1?"1px solid rgba(124,58,237,0.06)":"none"}}>
                      <div style={{width:20,height:20,borderRadius:6,background:"#ede9fe",display:"flex",alignItems:"center",justifyContent:"center",flexShrink:0}}>
                        <span style={{fontSize:9,fontWeight:700,color:"#6d28d9"}}>{i+1}</span>
                      </div>
                ...
                {selTicket&&(
                  <div className="gx-card" style={{flex:1,minHeight:0,overflowY:"auto"}}>
                    <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",marginBottom:10}}>
                      ...
                      <button onClick={()=>setSelTicket(null)} style={{width:22,height:22,borderRadius:6,border:"1px solid rgba(124,58,237,0.15)",background:"#fff",cursor:"pointer",display:"flex",alignItems:"center",justifyContent:"center",fontSize:11,color:"#6d28d9"}}>✕</button>
                    </div>
                    ...
                    <div style={{display:"flex",gap:6,marginBottom:8,flexWrap:"wrap"}}>
                      ...
                      <span style={{fontSize:9,fontWeight:700,padding:"2px 8px",borderRadius:5,background:"#f0eeff",color:"#6d28d9",textTransform:"capitalize"}}>{selTicket.status}</span>
                    </div>
