'use client'
/**
 * RetailSettingsPage.tsx  —  Retail / Nike / Popeyes
 *
...
const RetailSettingsPage:React.FC<Props>=({onNavigate,onLogout,user:propUser})=>{
                ...
                {section==="profile"&&(
                  <div>
                    ...
                    <div style={{display:"flex",alignItems:"center",gap:14,marginBottom:18,padding:"14px",background:"#f8f7ff",borderRadius:12,border:"1px solid rgba(124,58,237,0.1)"}}>
                      <div style={{width:52,height:52,borderRadius:"50%",background:"linear-gradient(135deg,#1d4ed8,#0369a1)",display:"flex",alignItems:"center",justifyContent:"center",fontSize:16,fontWeight:700,color:"#fff",flexShrink:0}}>
                      ...
                      <div>
                        ...
                        <div style={{fontSize:10,marginTop:3}}><span style={{background:"#dbeafe",color:"#0369a1",padding:"2px 8px",borderRadius:5,fontWeight:700,fontSize:9.5}}>{formatRole(propUser?.role)}</span></div>
                      </div>
                    </div>
