'use client'
/**
 * RetailUsersPage.tsx  —  Retail / Nike / Popeyes
 *
...
const RetailUsersPage:React.FC<Props>=({onNavigate,onLogout,user:propUser})=>{
          ...
          <div style={{flex:1,display:"flex",flexDirection:"column",gap:10,padding:"14px 20px",overflow:"hidden",minHeight:0}}>
            ...
            <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",flexShrink:0}}>
              <div>
                ...
                <div style={{fontSize:11.5,color:"#8e7ec0",marginTop:2}}>Nike Retail Users users</div>
              </div>
                          ...
                          <tr key={u.id??i} style={{borderBottom:"1px solid rgba(124,58,237,0.06)",transition:"background 0.1s"}}
                            ...
                            <td style={{padding:"10px 10px"}}>
                              <div style={{display:"flex",alignItems:"center",gap:8}}>
                                <div style={{width:32,height:32,borderRadius:"50%",background:"linear-gradient(135deg,#1d4ed8,#0369a1)",display:"flex",alignItems:"center",justifyContent:"center",fontSize:11,fontWeight:700,color:"#fff",flexShrink:0}}>
                                  {initials(u.name??"")}
                                </div>
                            ...
                            <td style={{padding:"10px"}}>
                              <button onClick={()=>setEditUser(u)} style={{fontSize:10.5,fontWeight:600,color:"#0369a1",background:"#dbeafe",border:"1px solid rgba(109,40,217,0.2)",borderRadius:6,padding:"3px 10px",cursor:"pointer"}}>Edit</button>
                            </td>
                          </tr>
                        ))}
                      </tbody>
                  ...
                  {loading?(
                    ...
                    Object.entries(roleCounts).map(([role,count])=>(
                      <div key={role} style={{display:"flex",alignItems:"center",justifyContent:"space-between",padding:"8px 0",borderBottom:"1px solid rgba(124,58,237,0.06)"}}>
                        ...
                        <span style={{fontSize:14,fontWeight:800,color:"#0369a1"}}>{count}</span>
                      </div>
                    ))
                  )}
...
export default RetailUsersPage;
