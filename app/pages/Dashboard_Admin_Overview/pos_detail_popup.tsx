...
import { POSDevice, Client, formatDate } from './dashboard_overview_func';
...
export default function POSDetailPopup({ pos, client, posIndex, onClose }: Props) {
  ...
  const warrantyDisplay = pos.warrantyDate
    ? new Date(pos.warrantyDate).toLocaleDateString('en-US', {
